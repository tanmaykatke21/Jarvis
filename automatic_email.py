...
people = {
    "mummy": "dimple1276@gmail.com",
    "papa": "santosh.shringarpure@gmail.com",
    "vritti": "vruttishringarpure@ternaengg.ac.in",
    "mayur":"mayurtotre@ternaengg.ac.in"
}
        ...
        if query=="yes":
            ...
            class GetEntry():
                def __init__(self, master):
                    ...
                    Button(master, text="send", width=10, bg="yellow",
            ...
            master = Tk()
            master.geometry("650x100+100+100")
